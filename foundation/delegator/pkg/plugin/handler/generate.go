...
//go:generate mockgen -package handler -destination=zz_mock_repo_test.go github.com/eu-sovereign-cloud/ecp/foundation/persistence/port Repo
...
//go:generate mockgen -package handler -destination=zz_mock_network_plugin_test.go github.com/eu-sovereign-cloud/ecp/foundation/delegator/pkg/plugin Network
