module github.com/eu-sovereign-cloud/ecp/foundation/delegator
...
replace github.com/eu-sovereign-cloud/ecp/foundation/plugin/aruba => ../plugin/aruba

replace github.com/eu-sovereign-cloud/ecp/foundation/plugin/ionos => ../plugin/ionos
