...
require (
	github.com/Arubacloud/arubacloud-resource-operator v0.0.1-alpha4
	github.com/eu-sovereign-cloud/ecp/foundation/gateway v0.0.0
...
require (
	...
	github.com/eu-sovereign-cloud/go-sdk v0.2.0 // indirect
