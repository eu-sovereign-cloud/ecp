...
//go:generate mockgen -package repository_test -destination=../../repository/zz_mock_repository_test.go github.com/eu-sovereign-cloud/ecp/foundation/plugin/aruba/pkg/adapter/generic/repository Cache,Informer
...
// Informer interface to be able to mock AddEventHandler
type Informer interface {
	AddEventHandler(handler kcache.ResourceEventHandler)
}

// Cache interface to mock GetInformer
type Cache interface {
	GetInformer(ctx context.Context, obj client.Object) (Informer, error)
}

// NewGenericRepository creates a new instance of GenericRepository.
func NewGenericRepository[T client.Object, L client.ObjectList](client client.Client, cache Cache) *GenericRepository[T, L] {
...
func (r *GenericRepository[T, L]) Watch(
	...
	handler := &kcache.ResourceEventHandlerFuncs{
		AddFunc: func(obj interface{}) {
			r.handle(obj, resource, out)
		},
		UpdateFunc: func(_, newObj interface{}) {
			r.handle(newObj, resource, out)
		},
...
func (r *GenericRepository[T, L]) handle(
	obj interface{},
	filter T,
	out chan T,
) {
