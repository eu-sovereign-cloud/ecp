...
type GenericConverter[S seca_gateway_port.IdentifiableResource, A any] struct {
...
var _ Converter[seca_gateway_port.IdentifiableResource, int] = (*GenericConverter[seca_gateway_port.IdentifiableResource, int])(nil)
