...
// Compile-time assertion that *Image satisfies common.Conditioned.
var _ common.Conditioned = (*Image)(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *Image) GetConditions() []types.StatusCondition {
...
func (x *Image) PushCondition(condition types.StatusCondition) {
	if x == nil {
		return
	}

	if x.Status == nil {
		x.Status = &types.ImageStatus{}
	}
...
// return nil.
func (x *Image) PeekConditions() *types.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
...
func (x *Image) LenConditions() int {
	if x == nil || x.Status == nil {
		return 0
	}
