...
// Compile-time assertion that *SecurityGroupRule satisfies common.Conditioned.
var _ common.Conditioned = (*SecurityGroupRule)(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *SecurityGroupRule) GetConditions() []types.StatusCondition {
...
func (x *SecurityGroupRule) PushCondition(condition types.StatusCondition) {
	if x == nil {
		return
	}
...
// return nil.
func (x *SecurityGroupRule) PeekConditions() *types.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
