...
// Compile-time assertion that *PublicIp satisfies common.Conditioned.
var _ common.Conditioned = (*PublicIp)(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *PublicIp) GetConditions() []types.StatusCondition {
...
func (x *PublicIp) PushCondition(condition types.StatusCondition) {
	if x == nil {
		return
	}

	if x.Status == nil {
		x.Status = &types.PublicIpStatus{}
	}
...
// return nil.
func (x *PublicIp) PeekConditions() *types.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
