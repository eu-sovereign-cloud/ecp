...
// Compile-time assertion that *Subnet satisfies common.Conditioned.
var _ common.Conditioned = (*Subnet)(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *Subnet) GetConditions() []types.StatusCondition {
...
func (x *Subnet) PushCondition(condition types.StatusCondition) {
	if x == nil {
		return
	}

	if x.Status == nil {
		x.Status = &types.SubnetStatus{}
	}
...
// return nil.
func (x *Subnet) PeekConditions() *types.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
...
func (x *Subnet) LenConditions() int {
	if x == nil || x.Status == nil {
		return 0
	}
