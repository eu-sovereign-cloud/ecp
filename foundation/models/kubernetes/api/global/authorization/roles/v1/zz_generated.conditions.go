...
// Compile-time assertion that *Role satisfies common.Conditioned.
var _ common.Conditioned = (*Role)(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *Role) GetConditions() []types.StatusCondition {
...
func (x *Role) PushCondition(condition types.StatusCondition) {
	if x == nil {
		return
	}
...
// return nil.
func (x *Role) PeekConditions() *types.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
