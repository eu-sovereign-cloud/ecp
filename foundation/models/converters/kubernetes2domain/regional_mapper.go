...
import (
	...
	"github.com/eu-sovereign-cloud/ecp/foundation/persistence/adapters/kubernetes/convert"
...
func MapWorkspaceDomainToCR(domain *regional.WorkspaceDomain) (client.Object, error) {
	...
	cr := &workspacev1.Workspace{
		ObjectMeta: v1.ObjectMeta{
			Name:            domain.Name,
			Namespace:       kubernetesadapter.ComputeNamespace(&scope.Scope{Tenant: domain.Tenant}),
			Labels:          crLabels,
