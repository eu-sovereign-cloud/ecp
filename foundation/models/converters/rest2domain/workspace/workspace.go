...
import (
	...
	v1 "github.com/eu-sovereign-cloud/ecp/foundation/models/kubernetes/api/global/regions/v1"
...
func domainToAPI(domain regional.WorkspaceDomain, verb string) *schema.Workspace {
	...
	sdk := &schema.Workspace{
		Metadata: &schema.RegionalResourceMetadata{
			...
			Ref:             fmt.Sprintf(domain.Provider+"/"+regional.TenantScopedResourceFormat, domain.Tenant, schema.RegionalResourceMetadataKindResourceKindWorkspace, domain.Name),
