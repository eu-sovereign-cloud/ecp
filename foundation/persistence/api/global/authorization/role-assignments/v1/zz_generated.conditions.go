...
// Compile-time assertion that *RoleAssignment satisfies common.Conditioned.
var _ common.Conditioned = (*RoleAssignment)(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *RoleAssignment) GetConditions() []types.StatusCondition {
...
func (x *RoleAssignment) PushCondition(condition types.StatusCondition) {
	if x == nil {
		return
	}
...
func (x *RoleAssignment) PopCondition() {
...
// return nil.
func (x *RoleAssignment) PeekConditions() *types.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
...
func (x *RoleAssignment) LenConditions() int {
	if x == nil || x.Status == nil {
		return 0
	}
