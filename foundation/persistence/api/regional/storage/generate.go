...
//go:generate go run ../../../cmd/conditioned-gen --header-file=../../../../../.github/boilerplate.go.txt --paths=./images/v1/...
//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen object:headerFile=../../../../../.github/boilerplate.go.txt paths=./images/v1/...
//go:generate go run sigs.k8s.io/controller-tools/cmd/controller-gen crd paths=./images/v1/... output:crd:artifacts:config=../../../generated/crds/storage
