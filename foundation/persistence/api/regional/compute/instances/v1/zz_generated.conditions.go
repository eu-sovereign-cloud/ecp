...
// Compile-time assertion that *Instance satisfies common.Conditioned.
var _ common.Conditioned = (*Instance)(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *Instance) GetConditions() []types.StatusCondition {
...
func (x *Instance) PushCondition(condition types.StatusCondition) {
	if x == nil {
		return
	}

	if x.Status == nil {
		x.Status = &types.InstanceStatus{}
	}
...
// return nil.
func (x *Instance) PeekConditions() *types.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
