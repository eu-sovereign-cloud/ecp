...
// Compile-time assertion that *RouteTable satisfies common.Conditioned.
var _ common.Conditioned = (*RouteTable)(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *RouteTable) GetConditions() []types.StatusCondition {
...
func (x *RouteTable) PushCondition(condition types.StatusCondition) {
	if x == nil {
		return
	}

	if x.Status == nil {
		x.Status = &types.RouteTableStatus{}
	}
...
// return nil.
func (x *RouteTable) PeekConditions() *types.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
