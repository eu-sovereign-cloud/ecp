...
// Compile-time assertion that *InternetGateway satisfies common.Conditioned.
var _ common.Conditioned = (*InternetGateway)(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *InternetGateway) GetConditions() []types.StatusCondition {
...
func (x *InternetGateway) PushCondition(condition types.StatusCondition) {
	if x == nil {
		return
	}
...
func (x *InternetGateway) PopCondition() {
...
// return nil.
func (x *InternetGateway) PeekConditions() *types.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
...
func (x *InternetGateway) LenConditions() int {
	if x == nil || x.Status == nil {
		return 0
	}
