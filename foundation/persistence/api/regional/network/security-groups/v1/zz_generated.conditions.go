...
// Compile-time assertion that *SecurityGroup satisfies common.Conditioned.
var _ common.Conditioned = (*SecurityGroup)(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *SecurityGroup) GetConditions() []types.StatusCondition {
...
func (x *SecurityGroup) PushCondition(condition types.StatusCondition) {
	if x == nil {
		return
	}

	if x.Status == nil {
		x.Status = &types.SecurityGroupStatus{}
	}
...
func (x *SecurityGroup) PopCondition() {
...
// return nil.
func (x *SecurityGroup) PeekConditions() *types.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
...
func (x *SecurityGroup) LenConditions() int {
	if x == nil || x.Status == nil {
		return 0
	}
