...
SCHEMA_DIR="internal/go-sdk/pkg/spec/schema"
OUTPUT_ROOT="apis/generated/types"
...
${GO_TOOL} -mod=mod  sigs.k8s.io/controller-tools/cmd/controller-gen object paths="./${OUTPUT_ROOT}"
