...
The delegator reconciles every region in its cluster unless
`ecp-delegator.regions` restricts it to the ones that deployment serves — see
[Regions](charts/delegator/README.md#regions).
