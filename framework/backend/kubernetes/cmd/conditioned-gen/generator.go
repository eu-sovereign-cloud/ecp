...
const (
	...
	statusTypesPkgPath = "github.com/eu-sovereign-cloud/ecp/framework/backend/kubernetes/schema/v1"
)
...
import (
	v1 "github.com/eu-sovereign-cloud/ecp/framework/backend/kubernetes/schema/v1"
