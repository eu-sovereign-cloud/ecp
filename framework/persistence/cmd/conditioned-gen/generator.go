...
const (
	...
	statusTypesPkgPath = "github.com/eu-sovereign-cloud/ecp/framework/persistence/kubernetes/schema/v1"
)
...
import (
	v1 "github.com/eu-sovereign-cloud/ecp/framework/persistence/kubernetes/schema/v1"

	metav1 "k8s.io/apimachinery/pkg/apis/meta/v1"
)
{{range .Targets}}
// Compile-time assertion that *{{.Name}} satisfies v1.Conditioned.
var _ v1.Conditioned = (*{{.Name}})(nil)

// GetConditions returns the Status.Conditions slice, or nil
// if the receiver, its Status or the slice is nil.
func (x *{{.Name}}) GetConditions() []v1.StatusCondition {
...
func (x *{{.Name}}) PushCondition(condition v1.StatusCondition) {
	if x == nil {
		return
	}
	...
	if x.Status.Conditions == nil {
		x.Status.Conditions = []v1.StatusCondition{}
	}
	...
	if prevCondition == nil {
		...
		x.Status.Conditions = append([]v1.StatusCondition{condition}, x.Status.Conditions...)
		x.Status.State = condition.State
		return
	}

	if v1.EqualConditions(*prevCondition, condition) {
...
// return nil.
func (x *{{.Name}}) PeekConditions() *v1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
