...
var _ schemav1.Conditioned = (*Subnet)(nil)

func (x *Subnet) GetConditions() []schemav1.StatusCondition {
...
func (x *Subnet) PushCondition(condition schemav1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *Subnet) PeekConditions() *schemav1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
