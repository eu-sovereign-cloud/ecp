...
var _ schemav1.Conditioned = (*SecurityGroupRule)(nil)

func (x *SecurityGroupRule) GetConditions() []schemav1.StatusCondition {
...
func (x *SecurityGroupRule) PushCondition(condition schemav1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *SecurityGroupRule) PeekConditions() *schemav1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
