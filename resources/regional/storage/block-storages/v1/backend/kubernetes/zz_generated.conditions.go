...
var _ genv1.Conditioned = (*BlockStorage)(nil)

func (x *BlockStorage) GetConditions() []genv1.StatusCondition {
...
func (x *BlockStorage) PushCondition(condition genv1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *BlockStorage) PeekConditions() *genv1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
