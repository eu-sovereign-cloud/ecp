...
// DomainToAPIWithVerb returns a func that converts a WorkspaceDomain to its SDK representation with the given verb.
func DomainToAPIWithVerb(verb string) func(domain *wsdom.WorkspaceDomain) *sdkschema.Workspace {
	return func(domain *wsdom.WorkspaceDomain) *sdkschema.Workspace {
		return domainToAPI(*domain, verb)
	}
}

// DomainToAPIIterator converts a list of WorkspaceDomain to an SDK WorkspaceIterator.
func DomainToAPIIterator(domains []*wsdom.WorkspaceDomain, nextSkipToken *string) *sdkworkspace.WorkspaceIterator {
...
// domainToAPI converts a WorkspaceDomain to a schema.Workspace with the given verb.
func domainToAPI(domain wsdom.WorkspaceDomain, verb string) *sdkschema.Workspace {
	resVersion := int64(0)
...
// APIToDomain converts an SDK Workspace to a WorkspaceDomain.
func APIToDomain(api sdkschema.Workspace, id *WorkspaceIdentity, region string) *wsdom.WorkspaceDomain {
