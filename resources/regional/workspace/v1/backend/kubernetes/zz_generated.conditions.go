...
var _ genv1.Conditioned = (*Workspace)(nil)

func (x *Workspace) GetConditions() []genv1.StatusCondition {
...
func (x *Workspace) PushCondition(condition genv1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *Workspace) PeekConditions() *genv1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
