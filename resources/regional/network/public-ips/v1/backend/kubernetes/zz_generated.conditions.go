...
var _ genv1.Conditioned = (*PublicIp)(nil)

func (x *PublicIp) GetConditions() []genv1.StatusCondition {
...
func (x *PublicIp) PushCondition(condition genv1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *PublicIp) PeekConditions() *genv1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
