...
var _ genv1.Conditioned = (*Nic)(nil)

func (x *Nic) GetConditions() []genv1.StatusCondition {
...
func (x *Nic) PushCondition(condition genv1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *Nic) PeekConditions() *genv1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
