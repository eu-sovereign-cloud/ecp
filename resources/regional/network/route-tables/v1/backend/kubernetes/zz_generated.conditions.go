...
var _ genv1.Conditioned = (*RouteTable)(nil)

func (x *RouteTable) GetConditions() []genv1.StatusCondition {
...
func (x *RouteTable) PushCondition(condition genv1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
		x.Status = &genv1.RouteTableStatus{}
	}
...
func (x *RouteTable) PeekConditions() *genv1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
