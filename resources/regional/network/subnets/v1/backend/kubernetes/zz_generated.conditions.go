...
var _ genv1.Conditioned = (*Subnet)(nil)

func (x *Subnet) GetConditions() []genv1.StatusCondition {
...
func (x *Subnet) PushCondition(condition genv1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *Subnet) PeekConditions() *genv1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
