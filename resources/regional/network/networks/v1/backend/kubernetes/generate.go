...
//go:generate go run go.uber.org/mock/mockgen -package kubernetes_test -destination ./zz_mock_plugin_test.go github.com/eu-sovereign-cloud/ecp/resources/regional/network/networks/v1/backend/kubernetes NetworkPlugin
