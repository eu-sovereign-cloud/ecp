...
var _ genv1.Conditioned = (*Network)(nil)

func (x *Network) GetConditions() []genv1.StatusCondition {
...
func (x *Network) PushCondition(condition genv1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
		x.Status = &genv1.NetworkStatus{}
	}
...
func (x *Network) PeekConditions() *genv1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
