...
var _ genv1.Conditioned = (*SecurityGroup)(nil)

func (x *SecurityGroup) GetConditions() []genv1.StatusCondition {
...
func (x *SecurityGroup) PushCondition(condition genv1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *SecurityGroup) PeekConditions() *genv1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
