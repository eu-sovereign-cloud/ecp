...
var _ schemav1.Conditioned = (*Workspace)(nil)

func (x *Workspace) GetConditions() []schemav1.StatusCondition {
...
func (x *Workspace) PushCondition(condition schemav1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *Workspace) PeekConditions() *schemav1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
