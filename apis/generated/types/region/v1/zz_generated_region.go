...
const (
	AcceptHeaderAcceptHeaderJson            AcceptHeader = "application/json"
	AcceptHeaderAcceptHeaderJsonDeletedOnly AcceptHeader = "application/json; deleted=only"
	AcceptHeaderAcceptHeaderJsonDeletedTrue AcceptHeader = "application/json; deleted=true"
)

// Defines values for ListRegionsParamsAccept.
const (
	ListRegionsParamsAcceptAcceptHeaderJson            ListRegionsParamsAccept = "application/json"
	ListRegionsParamsAcceptAcceptHeaderJsonDeletedOnly ListRegionsParamsAccept = "application/json; deleted=only"
	ListRegionsParamsAcceptAcceptHeaderJsonDeletedTrue ListRegionsParamsAccept = "application/json; deleted=true"
)
