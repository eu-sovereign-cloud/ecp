...
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,secapi.cloud}
// +crossbuilder:generate:xrd:claimNames:kind=XStorages,plural=xstorages,singular=xstorage
