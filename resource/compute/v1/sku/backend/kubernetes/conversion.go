...
// Converter is the CR<->domain conversion pair for InstanceSKU, so a call site names one value
// instead of pairing the two directions by hand. See doc/CONVENTIONS.md §2.
var Converter = k8sadapter.TwoWayConverter[*skudom.InstanceSKU]{
	FromCR: InstanceSKUFromCR,
	ToCR:   InstanceSKUToCR,
}
