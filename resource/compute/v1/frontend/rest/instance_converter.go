...
//
// The error is the rest.APIToDomain contract every sibling converter implements, not a result
// this body happens to produce — instance has no enum field to reject yet.
//
