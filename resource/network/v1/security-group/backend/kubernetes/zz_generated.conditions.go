...
var _ schemav1.Conditioned = (*SecurityGroup)(nil)

func (x *SecurityGroup) GetConditions() []schemav1.StatusCondition {
...
func (x *SecurityGroup) PushCondition(condition schemav1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *SecurityGroup) PeekConditions() *schemav1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
