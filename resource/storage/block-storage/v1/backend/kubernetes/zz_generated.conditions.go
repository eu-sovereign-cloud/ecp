...
var _ schemav1.Conditioned = (*BlockStorage)(nil)

func (x *BlockStorage) GetConditions() []schemav1.StatusCondition {
...
func (x *BlockStorage) PushCondition(condition schemav1.StatusCondition) {
	if x == nil {
		return
	}
	if x.Status == nil {
...
func (x *BlockStorage) PeekConditions() *schemav1.StatusCondition {
	if x == nil || x.Status == nil || len(x.Status.Conditions) == 0 {
		return nil
	}
