// Package rest provides REST↔domain conversion and HTTP handlers for the image resource.
package rest
...
// ListParamsFromAPI converts SDK ListImagesParams to resource.ListParams.
func ListParamsFromAPI(params sdkstorage.ListImagesParams, tenant string) resource.ListParams {
