// Package rest provides REST↔domain conversion and HTTP handlers for the role assignment resource.
package rest
...
func newRoleAssignmentWithIdentity(ir persistence.IdentifiableResource) *radom.RoleAssignment {
...
// ListParamsFromAPI converts SDK ListRoleAssignmentsParams to resource.ListParams.
func ListParamsFromAPI(params sdkauthz.ListRoleAssignmentsParams, tenant string) resource.ListParams {
