...
d.Controllers.
    ...
    Add(netk8s.NewController(d.Manager.GetClient(), d.Dynamic, d.Clientset, netPlugin, opts...)).
    Add(wsk8s.NewController(d.Manager.GetClient(), d.Dynamic, d.Clientset, wsPlugin, opts...))
